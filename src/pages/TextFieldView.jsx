        ...
        <DocCard
          ...
          content={
            <Card flat className="d-flex align-center justify-center flex-wrap">
              <TextField label="Text" className="my-3" />
              <TextField
                prepend="$"
                append="%"
                prefix="%"
                ...
                className="my-3"
              />
              <TextField label="Password" className="my-3" type="password" />
              <TextField label="Number" className="my-3" type="number" />
              <TextField label="Bordered" className="my-3" bordered />
              <TextField
                loading
              ...
              />
              <TextField disabled className="my-3" label="Disabled" />
              <TextField label="Rounded" rounded className="my-3" />
              <TextField label="Readonly" className="my-3" readonly />
              <TextField label="Dense" className="my-3" dense />
              <TextField
                label="Dense & Rounded"
                className="my-3"
                dense
