...
export const switchApi = (dark) => selectionControlApi(dark, 'Switch');

export const checkboxApi = (dark) => selectionControlApi(dark, 'Checkbox');

export const radioApi = (dark) => [
  ...selectionControlApi(dark, 'Radio', 'checked'),
];
