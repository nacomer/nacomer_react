...
export const textAvatar = () => `<Avatar>A</Avatar>
<Avatar bgColor='var(--error)'>AK</Avatar>`;

export const iconAvatar = () => `// Icon component is from '@mdi/react' and is not bundled with this library
...
export const colorAvatar = () => `<Avatar color='blue' bgColor='var(--warning)'>
  A
</Avatar>
...
export const varientAvatar = () => `<Avatar square bgColor='var(--warning)'>
  <Icon path={mdiFolder} size={1} />
</Avatar>
...
export const sizeAvatar = () => `<Avatar
  size='small'
  src='https://lh3.googleusercontent.com/a-/AAuE7mBL0Hh_wKgNlXtZks9XqIU3uv-j3COoKuYysLS_Svg'
/>
<Avatar
...
export const fallBackAvatar = () => `<Avatar src='broken.jpg' alt='Ankit Kumar Pandit' >
  AK
</Avatar>
