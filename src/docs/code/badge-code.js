...
const badge = (i, props) => `<Badge ${props}content={${i}}>
...
export const dotBadge = () => `${warn}
${badge(2, 'dot ')}
<Badge dot content={3}>
  Alert
</Badge>`;

export const borderedBadge = () => `${warn}
