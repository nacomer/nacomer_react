          ...
          >
            ...
            <Card flat className="d-flex justify-center">
              ...
              >
                ...
                >
                  <div className="clock-hand clock-hours" />
                  <div className="clock-hand clock-minutes" />
                  <div className="clock-hand clock-seconds" />
                  <div className="p-absolute clock-point" />
                </Card>
                <span className="p-absolute marker--1" />
                <span className="p-absolute marker--2" />
                <span className="p-absolute marker--3" />
                <span className="p-absolute marker--4" />
              </Card>
            </Card>
            <Card
              rounded={false}
