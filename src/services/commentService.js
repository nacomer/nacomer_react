export class CommentService {
    ...
    getCommentByHobby = async (hobbyId) => {
        const detailCommentResponse = await fetch(process.env.URL + "/api/hobby/" + hobbyId + "/comment").catch(err => {
    ...
    addComment = async (hobbyId, comment) => {
        await fetch(process.env.URL + "/api/hobby/" + hobbyId + "/comment/", {
            method: "POST",
            headers: {
    ...
    updateComment = async (hobbyId, commentId, commentText) => {
        await fetch(process.env.URL + "/api/hobby/" + hobbyId + "/comment/" + commentId, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
